...
4. Always end with a markdown link as the backup, exactly in this form: `**[Open Dashboard](<url>)**` — and remind: ctrl+alt+d reopens it in-IDE anytime; the dashboard self-stops after 30 idle minutes and any `/conductor:dashboard` revives it at the same URL.
